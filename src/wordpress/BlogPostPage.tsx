import {BUILD_URL, WORDPRESS_URL} from '../settings'
...
const BlogPostPage = (props: { entries: CategoryWithEntries[], post: FormattedPost }) => {
    const {entries, post} = props
    const authorsText = formatAuthors(post.authors)

    const pageTitle = post.title
    const canonicalUrl = `${BUILD_URL}/${post.slug}`
