;(function() {	
	...
	owid.models.mapdata = function(chart) {
		...
		function updateCurrentValues() {
			...
			mapdata.minCurrentValue = _.minBy(_.values(currentValues), function(d) { return d.value; }).value;
			mapdata.maxCurrentValue = _.maxBy(_.values(currentValues), function(d) { return d.value; }).value;
			mapdata.minToleranceYear = _.minBy(_.values(currentValues), function(d) { return d.year; }).year;
			mapdata.maxToleranceYear = _.maxBy(_.values(currentValues), function(d) { return d.year; }).year;
